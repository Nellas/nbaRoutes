var app = angular.module('nbaRoutes').controller('teamCtrl', function($scope, $routeParams, teamService, teamData){
    ...
    $scope.submitGame = function() {
        $scope.newGame.homeTeam = $scope.newGame.homeTeam.split(' ').join('').toLowerCase()
